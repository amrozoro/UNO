...
public class UI {
    ...
    */
    ...
    public static void SetUpMainMenuFrame(){
        ...
        ImageIcon icon = new ImageIcon("Assets\\Images\\Title.png");
    ...
    public static void SetUpGameFrame(){
        ...
        ImageIcon icon = new ImageIcon("Assets\\Images\\Cards\\Misc\\BackOfCard.png"); //storing back of card icon for use later
    ...
    */
    public static String DisplayInputDialog(FramesEnum frame, String message){
        return JOptionPane.showInputDialog(UI.framesDict.get(frame), message);
    }
    //</editor-fold>
    ...
    */
    public static JLabel CreateComputerCardLabel(Card card){
        ...
        JLabel label = CreateLabel(new ImageIcon("Assets\\Images\\Cards\\Misc\\BackOfCard.png"), 0, 0, FramesEnum.Game, true); //correct posX will be set through "AlignCardLabels" method
    ...
    */
    public static void UpdateHighscoresTable(){
        ...
        try {
            ...
            File file = new File("Assets\\Text Files\\Highscores.txt");
    ...
    */
    public static void AddToHighscores(String string){
        try {
            ...
            FileWriter fw = new FileWriter("Assets\\Text Files\\Highscores.txt", true);
